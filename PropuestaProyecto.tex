...
\subsection{Vehículo Aéreo No Tripulado, Sistema de Aeronaves No Tripulados y Modelos Radiocontrolados}

Un Sistema de Aeronaves No Tripulados son aeronaves no tripuladas junto con las instalaciones de control terrestre, networking y el personal certificado para el piloteo de estas aeronaves \cite{AusGov2013Online}
...
\bibliography{bib_refs_data}  % sigproc.bib is the name of the Bibliography in this case
\end{document}
